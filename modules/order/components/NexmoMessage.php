 ...
 * 
 * Usage: $var = new NexmoMessage ( $account_key, $account_password );
 * Methods:
...
class NexmoMessage extends Component
 {
	...
	private function sendRequest ( $data ) {
		...
		if (function_exists('curl_version')) {	
			...
			if (!$this->ssl_verify) {
				...
				curl_setopt($to_nexmo, CURLOPT_SSLVERSION, CURL_SSLVERSION_TLSv1);
			}
